...
class RepositoryManifestResponse(object):
    ...
    def __init__(self, manifests=None, namespace=None, revision=None, server=None, source_type=None, verify_result=None):  # noqa: E501
        """RepositoryManifestResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RepositoryManifestResponse, dict):
