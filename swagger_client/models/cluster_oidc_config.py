...
class ClusterOIDCConfig(object):
    ...
    swagger_types = {
        'cli_client_id': 'str',
        'client_id': 'str',
        'enable_pkce_authentication': 'bool',
    ...
    attribute_map = {
        ...
        'client_id': 'clientID',
        'enable_pkce_authentication': 'enablePKCEAuthentication',
    ...
    def __init__(self, cli_client_id=None, client_id=None, enable_pkce_authentication=None, id_token_claims=None, issuer=None, name=None, scopes=None):  # noqa: E501
        """ClusterOIDCConfig - a model defined in Swagger"""  # noqa: E501
        self._cli_client_id = None
        self._client_id = None
        self._enable_pkce_authentication = None
        ...
        if enable_pkce_authentication is not None:
            self.enable_pkce_authentication = enable_pkce_authentication
    ...
    @property
    def enable_pkce_authentication(self):
        """Gets the enable_pkce_authentication of this ClusterOIDCConfig.  # noqa: E501


        :return: The enable_pkce_authentication of this ClusterOIDCConfig.  # noqa: E501
        :rtype: bool
        """
        return self._enable_pkce_authentication

    @enable_pkce_authentication.setter
    def enable_pkce_authentication(self, enable_pkce_authentication):
        """Sets the enable_pkce_authentication of this ClusterOIDCConfig.


        :param enable_pkce_authentication: The enable_pkce_authentication of this ClusterOIDCConfig.  # noqa: E501
        :type: bool
        """

        self._enable_pkce_authentication = enable_pkce_authentication
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClusterOIDCConfig, dict):
