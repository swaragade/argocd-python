...
class ApplicationApplicationSyncWindowsResponse(object):
    ...
    def __init__(self, active_windows=None, assigned_windows=None, can_sync=None):  # noqa: E501
        """ApplicationApplicationSyncWindowsResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApplicationApplicationSyncWindowsResponse, dict):
