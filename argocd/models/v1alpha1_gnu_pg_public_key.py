...
class V1alpha1GnuPGPublicKey(object):
    ...
    def __init__(self, fingerprint=None, key_data=None, key_id=None, owner=None, sub_type=None, trust=None):  # noqa: E501
        """V1alpha1GnuPGPublicKey - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1GnuPGPublicKey, dict):
