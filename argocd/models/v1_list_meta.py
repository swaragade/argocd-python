...
class V1ListMeta(object):
    ...
    def __init__(self, _continue=None, remaining_item_count=None, resource_version=None, self_link=None):  # noqa: E501
        """V1ListMeta - a model defined in Swagger"""  # noqa: E501
