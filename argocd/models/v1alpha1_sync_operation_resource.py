...
class V1alpha1SyncOperationResource(object):
    ...
    def __init__(self, group=None, kind=None, name=None, namespace=None):  # noqa: E501
        """V1alpha1SyncOperationResource - a model defined in Swagger"""  # noqa: E501
        self._group = None
        self._kind = None
        self._name = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1SyncOperationResource, dict):
